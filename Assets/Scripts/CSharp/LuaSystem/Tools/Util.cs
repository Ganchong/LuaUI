...
namespace LuaFrameworkCore {
    ...
    public class Util {
		...
		{
			return RegisterComponent.GetComponent(trans, compName);
		}
		public static Transform[] GetChildByCount(Transform parent, int count)
		{
			return CommonFunction.GetChildByCount(parent, count).ToArray();
		}
